...
**下一步**：三份 brief 交 Fable 5 出 design——**P1 留言 ingest 增補**（P1 design 已完成，留言為 additive 擴充）、**P2 三條 ML 垂直**（tabular＋LangGraph RAG＋HuggingFace 微調 A/B）、**P3 PTT ingest（Kafka 鎖定）**。P4 呈現層＋MCP add-on 待 P2 後接。plan 全延後。
